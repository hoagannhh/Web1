...
function CaculateTotalMoney(){
    ...
    document.querySelector(".total-cost").textContent = formatVND_manual(Number(totalMoney));
    document.querySelector(".total-cost-product").textContent = formatVND_manual(Number(totalMoney));
}
...
function CreateProduct(inforProduct){
    html += `
            <div id=${inforProduct.id} class="product-bought" checked = "${inforProduct.selected || false}">
                ...
                <div class="detail-product">
                    <div class="represent">
                        ...
                        <div class="navigator">
                            ...
                            <input  class="quantity" type="number" value="${inforProduct.quantity || 1}">
                            <button  class="add">+</button>
                        </div>
                    </div>
                    <div class="infor-product-bought">
                        <p class="name">${inforProduct.name}</p>
                        <p class="kind-of-shoes">${inforProduct.gender + "'s Shoes"}</p>
